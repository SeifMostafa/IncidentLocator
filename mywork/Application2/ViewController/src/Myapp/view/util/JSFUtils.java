...
public class JSFUtils {
    ...
    //    public void getAttribute(HttpServletRequest request, HttpServletResponse response , String attrName)
    ...
    public static ResourceBundle getResourceBundle() {
            if (bundle == null) {
                ...
                bundle = context.getApplication().getResourceBundle(context, "bnd");
            }
            return bundle;
        }
